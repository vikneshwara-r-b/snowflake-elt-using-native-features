...
alter task classic_db.orchestration.copy_to_order_bronze_task resume;
alter task classic_db.orchestration.copy_to_customer_bronze_task resume;
alter task classic_db.orchestration.root_task resume;

-- suspend statements..
alter task classic_db.orchestration.root_task suspend;
alter task classic_db.orchestration.copy_to_customer_bronze_task suspend;
alter task classic_db.orchestration.copy_to_order_bronze_task suspend;
